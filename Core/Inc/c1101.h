...
#define SS 4          //I might need to invert
#define MISO_PORT GPIOA
#define MISO 6
#define GDO0_PORT GPIOA
#define GDO0 2
#define GDO2_PORT GPIOA
#define GDO2 3
/**
 * Carrier frequencies
 */
...
#define CC1101_DEFVAL_FREQ2_918  0x23        // Frequency Control Word, High uint8_t
#define CC1101_DEFVAL_FREQ1_918  0x4E        // Frequency Control Word, Middle uint8_t
#define CC1101_DEFVAL_FREQ0_918  0xC4        // Frequency Control Word, Low uint8_t
...
//    *SPIF is 7 bit in SPSR. It's SPI interrupt flag. When serial transfer is complete, flag is set
//    *SPDR is SPI data register read/write register used for data transfer,
//*/
//  while(!(SPSR & _BV(SPIF)));
//  rcvd = SPDR;
//#endif
